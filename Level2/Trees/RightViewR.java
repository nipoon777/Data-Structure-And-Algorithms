...
public class Main {
    ...
    public static void rightView(TreeNode node, int level, ArrayList<Integer> rightView){
        if( node == null ){
            return;
        }
        ...
        rightView(node.right, level + 1, rightView);
        rightView(node.left, level + 1, rightView);
    }
